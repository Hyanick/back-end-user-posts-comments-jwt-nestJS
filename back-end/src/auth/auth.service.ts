...
export class AuthService {
  ...
  async signup(signupDto: SignupDto) {
    const { email, password, username, passwordConfirm, lastDateConnexion } =
      signupDto;
    ...
    if (password !== passwordConfirm)
      throw new ConflictException('Les 2 mots de passe ne sont pas identiques');
